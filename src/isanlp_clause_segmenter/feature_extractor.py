...
class FeatureExtractor:
    def __init__(self):
        ...
        self.out_categorical_features = [
            ...
            'person_ancestor_2_1',
            'tense_ancestor_2_1',
            'verbform_ancestor_2_1',
            'voice_ancestor_2_1',
            'deprel_ancestor_2_1',
            'lemma_ancestor_1_0',
            'upos_ancestor_1_0',
            'animacy_ancestor_1_0',
            'aspect_ancestor_1_0',
            'case_ancestor_1_0',
            'degree_ancestor_1_0',
            'gender_ancestor_1_0',
            ...
            'person_ancestor_1_0',
            'tense_ancestor_1_0',
            'verbform_ancestor_1_0',
            'voice_ancestor_1_0',
            'deprel_ancestor_1_0',
        ]

        self.out_other_features = [
            'is_capitalized',
            'is_upper',
            'position',
            'distance_to_end',
            ...
            'is_upper_prev_2',
            'n_children_prev_2',
            'is_capitalized_ancestor_2_1',
            'is_upper_ancestor_2_1',
            'n_children_ancestor_2_1',
            'distance2_ancestor_2_1',
            'distance1_ancestor_2_1',
            'is_capitalized_ancestor_1_0',
            'is_upper_ancestor_1_0',
            'n_children_ancestor_1_0',
            'distance1_ancestor_1_0',
            'distance0_ancestor_1_0',
            'same_common_ancestors'
        ]

    def __call__(self, sentences):
        df = self.to_dataframe(sentences)
        features = FeatureExtractor._add_previous_word_features(df, 2, self.categorical_features, self.other_features)
        # features = FeatureExtractor._parallelize_dataframe(df, self._func_previous)
        ...
        return features[self.out_categorical_features + self.out_other_features]
            ...
            for word_index, word_data in enumerate(sentence):
                try:
                    features = {
                        ...
                        'parent_lemma': sentence[word_data['head'] - 1]['lemma'] if word_data[
                                                                                        'head'] > -1 else 'NA',
                        'parent_upos': sentence[word_data['head'] - 1]['upostag'] if word_data[
                                                                                         'head'] > -1 else 'NA',
                    ...
                    if word_data['misc'] is not None and 'BeginSeg' in word_data['misc']:
                        features['begin_segment'] = int(word_data['misc']['BeginSeg'] == 'Yes')
    ...
    def _func_previous(self, d):
        return FeatureExtractor._add_previous_word_features(d, 2, self.categorical_features, other_features)
